...
////////////////////////// Callbacks //////////////////////////
///////////////////////////////////////////////////////////////
void AdmittanceController::state_arm_callback(const sim_admittance_control::PoseTwistConstPtr msg) {
...
void AdmittanceController::compute_admittance() {
  ...
  while (init_count_ < 100)
  {
    equilibrium_orientation_.coeffs() << 0.0, 0.0, 0.0, 1.0; 
    equilibrium_position_ << 0.5, 0.5, 0.5;
    init_count_++;
  }
