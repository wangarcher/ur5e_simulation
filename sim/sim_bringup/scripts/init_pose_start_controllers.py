...
def clear_wrenches():
    subprocess.check_call("rosservice call /gazebo/clear_body_wrenches \"body_name: 'raigor'\"", shell=True)
...
def start_ros_controllers():
    ...
    req.start_controllers.append("raigor_cartesian_velocity_controller_sim")
    req.start_controllers.append("joint_state_controller")
    # req.stop_controllers.append("arm_joint_controller")
