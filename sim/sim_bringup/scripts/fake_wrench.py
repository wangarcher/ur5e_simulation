...
def publisherCallback( msg ):
    try:
        ...
        (trans2,rot2) = listener.lookupTransform("/world", "/robotiq_coupler", rospy.Time(0))
        (trans3,rot3) = listener.lookupTransform("/robotiq_coupler", "/world",rospy.Time(0))
        ...
        fake_wrench.header.frame_id = "robotiq_coupler"
